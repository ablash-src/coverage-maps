...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Roboto, sans-serif; background-color: #f5f7fa; color: #333; }
        ...
        .map-section { background: white; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); overflow: hidden; border: 1px solid #e0e6ed; }
        ...
        .nav-links { padding: 12px 24px; background: #f5f7fa; border-top: 1px solid #e8ecf0; }
        .nav-links a { color: #0277bd; text-decoration: none; font-size: 13px; margin-right: 20px; font-weight: 500; }
        .nav-links a:hover { text-decoration: underline; color: #01579b; }
